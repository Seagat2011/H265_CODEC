...
p = new Player({
  useWorker: <bool>,
  workerFile: <defaults to "Decoder.00"> // give path to Decoder.00
...
(function (root, factory) {
  ...
  var Player = function(parOptions){
    ...
    this._config.workerFile = this._config.workerFile || "Decoder.00";
    ...
    if (this._config.useWorker){
      ...
      if (this._config.transferMemory){
        alert("Player.js:124 - this._config.transferMemory operation disabled")
/*
...
*/
  ...
  Player.prototype = {
    ...
    _createBasicCanvasObj: function(options){
      ...
      obj.canvas.style.backgroundColor = "#202020";
      return obj;
    },
    // options:
    //
